...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bingPicImg = (ImageView) findViewById(R.id.bing_pis_img);
    ...
    public void requestWeather(final String weatherCode){
        String weatherUrl = "http://guolim.tech/api/weather?cityid=" + weatherCode + "&key=bc0418b57b2d4918819d3974ac1285d9";
        Log.d("Anvei", "Node1: " + weatherUrl);
